//
//  DribbleOrPassGetReadyView.swift
//  FootballScanningAI
//
//  PBA V2 — Activity 3: Countdown then navigate to Display session.
//

import SwiftUI

struct DribbleOrPassGetReadyView: View {
    ...
    private var activity: ActivityKind { .dribbleOrPass }
