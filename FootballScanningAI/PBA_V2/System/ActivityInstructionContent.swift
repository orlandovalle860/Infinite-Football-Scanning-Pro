    ...
    static func content(for activity: ActivityKind) -> ActivityInstructionData {
        ...
        case .twoMinuteTest:
            return ActivityInstructionData(
                ...
                whatToDo: "Your first touch must take you out through the same side as the ball. Decide before the ball arrives.",
        ...
        case .awayFromPressure:
            return ActivityInstructionData(
                ...
                whatToLookFor: "Red = pressure. Open gate = dribble space. After the beep, a red zone appears in one direction—that’s where pressure is. Other gates are open space.",
        ...
        case .dribbleOrPass:
            return ActivityInstructionData(
                ...
                whatToLookFor: "Red = pressure. Green = teammate. Open gate = dribble space. After the beep, each gate shows one: red fill (avoid), green fill (pass), or open (dribble).",
